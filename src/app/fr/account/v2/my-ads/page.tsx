...
export default async function MyAdsPage(props: Props) {
  const resolvedSearchParams = await props.searchParams
  const status = (resolvedSearchParams?.status ?? "PUBLISHED") as AdStatus
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-6xl mx-auto px-6 py-4 flex gap-8 text-sm font-medium text-gray-600">
          ...
          <Link
            href="/fr/account/v2/my-orders"
            className="flex items-center gap-2 px-3 py-2 rounded-lg text-gray-600 hover:bg-gray-100 hover:text-black transition"
          >
